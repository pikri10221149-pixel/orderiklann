...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-cubes"></i> Data Iklan</h6>
            </div>
            <div class="card-body">
                <center>
            ...
            <div class="card-footer">
                <a href='index.php?page=barang'>Tabel
                    Iklan <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
        <!--/grey-card -->
    </div><!-- /col-md-3-->
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-chart-bar"></i> Jumlah Iklan</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fa fa-bookmark"></i> Jenis Iklan</h6>
            </div>
            <div class="card-body">
                <center>
            ...
            <div class="card-footer">
                <a href='index.php?page=kategori'>Tabel
                    Jenis Iklan <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
        <!--/grey-card -->
    </div><!-- /col-md-3-->
